...
public class ToastNotification2 extends JDialog {
    ...
    public ToastNotification2(Window parent, Type type, String message) {
        super(parent);
        this.type = type;
        setUndecorated(true);
    ...
    public void dispose() {
        super.dispose();
        NotificationManager2.getInstance().removeNotification(this);
    }
