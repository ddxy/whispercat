...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("icon/svg/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("icon/svg/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("icon/svg/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("icon/svg/light.svg"));
        }
    }
